    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Park>()
        .HasData(
          ...
          new Park { ParkId = 5, Name = "Calvert Cliffs", Agency = "Maryland Department of Natural Resources (DNR)", State = "Utah", Description = "Public recreation area in Lusby, Calvert County, Maryland, that protects a portion of cliffs that extend for 24 miles along the eastern flank of the Calvert Peninsula on the west side of Chesapeake Bay from Chesapeake Beach southward to Drum Point. Nice boardwalk for a wooded hike to the beach.", Campsites = false },
